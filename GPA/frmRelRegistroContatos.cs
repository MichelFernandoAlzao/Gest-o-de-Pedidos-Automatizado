...
{
    public partial class frmRelRegistroContatos : Form
    {
        ...
        public frmRelRegistroContatos(string inCaminhoBanco, string inUsuario)
        {
            InitializeComponent();
...
{
                        "Formularios.Relatorios.RegistroContatos.rdlc",
                        LIDUsuario.ToString(),
                        txtDataInicial.Text,
                        txtDataFinal.Text,
                        LID
